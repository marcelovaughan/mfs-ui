...
var findNextFirstChar = function findNextFirstChar(firstChars, startIndex, _char) {
  for (var i = startIndex; i < firstChars.length; i += 1) {
    if (_char === firstChars[i]) {
      return i;
    }
  }
...
var TreeView = /*#__PURE__*/React.forwardRef(function TreeView(props, ref) {
  ...
  var focusByFirstCharacter = function focusByFirstCharacter(id, _char2) {
    var start;
    var index;

    var lowercaseChar = _char2.toLowerCase();
